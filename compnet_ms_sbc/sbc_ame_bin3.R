...
alpha <- -1
sigma <- 0.5
trait1_trait2_corr <- -0.5
beta_trait1_sp <- 0.1
beta_trait1_dist <- -2.5
beta_trait2_sp <- -0.4
beta_trait2_dist <- 1
...
# label-switching.
multi_effects_corr <- -0.3
multi_effects_sigma <- c(0.5, 0.3)
...
saveRDS(sbc_mods_and_data, "sbc_ame_bin3_out.RDS")
