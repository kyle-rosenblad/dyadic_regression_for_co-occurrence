...
alpha <- 1.2
sigma <- 0.8
trait1_trait2_corr <- 0.3
beta_trait1_sp <- -0.5
beta_trait1_dist <- 1.6
beta_trait2_sp <- 0.7
beta_trait2_dist <- -2.2
...
# label-switching.
multi_effects_corr <- -0.4
multi_effects_sigma <- c(0.5, 0.4)
...
saveRDS(sbc_mods_and_data, "sbc_ame_bin1_out.RDS")
